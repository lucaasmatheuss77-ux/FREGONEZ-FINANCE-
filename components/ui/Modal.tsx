...
export function Modal({ isOpen, onClose, title, children, className }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className={cn(
        "relative w-full sm:max-w-lg bg-white rounded-t-3xl sm:rounded-2xl shadow-[0_20px_80px_rgba(124,58,237,0.2)] max-h-[90vh] overflow-y-auto border border-purple-100",
        className
      )}>
