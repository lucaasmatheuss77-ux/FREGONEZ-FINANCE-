  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 px-3 pb-safe-area-inset-bottom pb-3">
        <div className="bg-white/94 backdrop-blur-xl border border-[rgba(27,58,27,0.12)] shadow-[0_-4px_32px_rgba(27,58,27,0.10)] rounded-2xl max-w-md mx-auto">
              ...
              return (
                <Link key={href} href={href} className="flex-1">
                  <div className={cn(
                    ...
                    <span className={cn("text-[10px] font-semibold leading-none", active ? "text-[#1B3A1B]" : "text-gray-400")}>
                      {label}
                    </span>
                  </div>
                </Link>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none max-w-md mx-auto">
        <div className="flex justify-center pb-[52px]">
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #7A5B08, #B07D10, #C8992A)",
          ...
          >
            ...
            {/* Live indicator */}
            <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 bg-[#1B3A1B] rounded-full border-2 border-white flex items-center justify-center">
